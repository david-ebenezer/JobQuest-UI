...
const SearchDiv = () => {
  return (
    <div className="searchDiv grid gap-10 bg-greyIsh rounder-[10px] p-[3rem]">
      <form action="">
        <div className='firstDive flex justify-between items-center rounded-[8px] gap-[10px] bg-white p-5 shadow-lg shadow-greyIsh-700'>
